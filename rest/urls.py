...
urlpatterns = [
    ...
    url(r'^taxon_dashboard/', include('apps.taxon_dashboards.rest_urls', namespace="taxon_dashboard-api")),
    ...
    url(r'^inventory/', include('apps.rapid_inventories.rest_urls', namespace="inventory-api")),
