...
export class Gauge {
  constructor(configuration) {
    ...
    const pointerWidth      = this.mwidth *.025;
    const pointerTailLength = this.mwidth *.025;
    const pointerHeadLength = this.mwidth *.4;
    this.lineData = [
      [pointerWidth , 0],
      [0, -pointerHeadLength],
      [-(pointerWidth ), 0],
