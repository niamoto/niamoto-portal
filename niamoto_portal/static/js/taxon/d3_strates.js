...
export function initBarh() {
    ...
    const svg = d3.select("#strate").append("svg")
        .attr("width", width)
        .attr("height", height);
    ...
    function updateData(data) {
        ...
        const emergent = data['plot']['properties']['emergent'];
        const canopy = data['plot']['properties']['canopy'];
        const under_canopy = data['plot']['properties']['undercanopy'];
        const under_storey = data['plot']['properties']['understorey'];
